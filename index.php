	...
	<head>
		...
		<body>
			...
			<div class="container" style="background-color: burlywood;">
				...
				<div class="row">
						<div class="col-md-12">
							<img src="Image/any.jpg" style="width:100%;height:200px;">
						</div>
				</div>
				
				<div class="row">
					<div class="col-md-12">
					  <ul class="nav  nav-justified" style="background-color:peru;width:100%;height:60px;">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12">
					   <div class="well" style="background-color:tan;"> 
				
						<h1 align="center">My awesome's Blog</h1>
							...
							<menu>
								<ul align="left">
									<li><a href="delete_post.php?id=<?php echo $post['post_id']; ?>">Delete This post.</a></li><hr>
				...
				<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="well" style="background-color: darksalmon; color: navy;">
